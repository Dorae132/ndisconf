package com.nsb.ndisconf.server.disconf.web.service.roleres.service;
...
import com.nsb.ndisconf.server.dsp.common.exception.AccessDeniedException;
...
public class RoleResourceAspect {
     ...
     * @throws Throwable
     */
    @Around("anyPublicMethod() && @annotation(requestMapping) && !@annotation(com.nsb.ndisconf.server.dsp.common.annotation.NoAuth) && within(com.nsb.ndisconf.server..*)")
