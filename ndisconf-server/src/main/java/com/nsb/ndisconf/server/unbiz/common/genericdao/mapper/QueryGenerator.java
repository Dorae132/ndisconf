package com.nsb.ndisconf.server.unbiz.common.genericdao.mapper;
...
import com.nsb.ndisconf.server.unbiz.common.genericdao.bo.InsertOption;
import com.nsb.ndisconf.server.unbiz.common.genericdao.dao.GenericDao;
...
import com.nsb.ndisconf.server.unbiz.common.genericdao.operator.Query;
import com.nsb.ndisconf.server.unbiz.common.genericdao.param.BetweenParam;
import com.nsb.ndisconf.server.unbiz.common.genericdao.param.ExpressionParam;
import com.nsb.ndisconf.server.unbiz.common.genericdao.param.GreaterThanParam;
import com.nsb.ndisconf.server.unbiz.common.genericdao.param.GteParam;
import com.nsb.ndisconf.server.unbiz.common.genericdao.param.IncrParam;
import com.nsb.ndisconf.server.unbiz.common.genericdao.param.LessThanParam;
import com.nsb.ndisconf.server.unbiz.common.genericdao.param.LikeParam;
import com.nsb.ndisconf.server.unbiz.common.genericdao.param.LteParam;
import com.nsb.ndisconf.server.unbiz.common.genericdao.param.NotParam;
...
public class QueryGenerator<ENTITY extends BaseObject<KEY>, KEY extends Serializable> {
     ...
     */
    public Query getCreateQuery(boolean generateKey, boolean quick, List<ENTITY> entities) {
        return getCreateQuery(entities, generateKey, quick, null);
    }

    // 
    public Query getCreateQuery(boolean generateKey, boolean quick, InsertOption option, List<ENTITY> entities) {
        return getCreateQuery(entities, generateKey, quick, option);
    }
