package com.nsb.ndisconf.server.unbiz.common.genericdao.dao;
...
import com.nsb.ndisconf.server.unbiz.common.genericdao.annotation.Sequence;
import com.nsb.ndisconf.server.unbiz.common.genericdao.bo.InsertOption;
import com.nsb.ndisconf.server.unbiz.common.genericdao.mapper.GenericMapper;
import com.nsb.ndisconf.server.unbiz.common.genericdao.mapper.ORMapping;
import com.nsb.ndisconf.server.unbiz.common.genericdao.mapper.QueryGenerator;
...
import com.nsb.ndisconf.server.unbiz.common.genericdao.operator.Operators;
...
import com.nsb.ndisconf.server.unbiz.common.genericdao.sequence.SequenceGenerator;
import com.nsb.ndisconf.server.unbiz.common.genericdao.util.ClassUtils;
...
public abstract class GenericDao<KEY extends Serializable, ENTITY extends BaseObject<KEY>> implements
	...
	protected static Logger log=LoggerFactory.getLogger(GenericDao.class);
    ...
    public ENTITY create(ENTITY entity, InsertOption option) {
        ...
        // 获取insert语句
        Query query = queryGenerator.getCreateQuery(autoGeneratedKey, false, option, Arrays.asList(entity));
