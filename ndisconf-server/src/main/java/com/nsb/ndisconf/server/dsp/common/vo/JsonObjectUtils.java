...
import com.nsb.ndisconf.server.dsp.common.context.ContextReader;
...
public class JsonObjectUtils {
    ...
    public static <T> JsonObjectBase buildSimpleObjectSuccess(T value) {
        ...
        LOG.info("buildSimpleObjectSuccess\n\t"+JsonUtils.toJson(json));
